...
- **Relevant Ships:** Carriers and Light Carriers
- As with the blue rarity dive bombers, the increased base damage of these torpedo bombers makes up for the damage penalty they suffer from being low tech level. Both are functionally upgrades over the Devastator and B5N respectively.
...
#### 2-2
- **Useful Equipment:** naval camo, four separate blue rarity anti-air guns
